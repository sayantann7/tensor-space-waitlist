      ...
      <div className="relative z-20 w-full max-w-sm sm:max-w-lg mx-auto my-8 p-4 sm:p-6 md:p-8 lg:p-12 bg-[#FFEBC4] bg-opacity-100 rounded-[24px] sm:rounded-[32px] lg:rounded-[48px] shadow-2xl flex flex-col items-center border border-[#ffe0b2]/60" style={{ boxShadow: '0 8px 64px 0 #ff910033' }}>
        ...
        {notSubscribed ? (
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col items-center gap-6">
            ...
            <button
              type="submit"
              className={`w-full sm:w-[200px] py-4 rounded-full font-normal text-base sm:text-lg mt-2 transition-all duration-150 hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed font-coolvetica ${subscribed && !loading ? 'bg-black text-white' : 'bg-[#d9d9d9] text-[#7a4a00]'}`}
