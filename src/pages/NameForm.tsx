    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ background: "radial-gradient(ellipse 60% 50% at 60% 60%, #ff9100 0%, #ffe0b2 100%)", minHeight: '100vh' }}>
      ...
      <div className="relative z-20 w-full max-w-lg mx-auto p-10 bg-white rounded-[48px] shadow-2xl flex flex-col items-center border-none" style={{ boxShadow: '0 8px 64px 0 #ff910033' }}>
        ...
        <h1 className="text-center text-[#7a4a00] text-2xl md:text-3xl font-normal mb-8" style={{ fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif' }}>
          Give a name the <span className="italic font-normal" style={{ fontFamily: 'Times, serif', color: '#7a4a00' }}>coziest</span><br />workstation on the planet
        </h1>
        <form onSubmit={handleSubmit} className="w-full flex flex-col items-center gap-6">
          <div className="w-full relative">
            <input
              ...
              required
            />
            <span className="absolute right-3 bottom-2 text-xs text-[#7a4a00] opacity-70 select-none" style={{ fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif' }}>{name.length}/{maxChars}</span>
          </div>
          ...
          <button
            ...
            style={{ fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif', boxShadow: '0 2px 8px #00000022' }}
          >
            Submit
          </button>
        </form>
